...
namespace PluginIntegracao
{
    public class ImportOpportunity : PluginImplementation
    {
        ...
        private void CreateUpdateReferences()
        {
            Entity opportunityInDynamics2 = RetrieveOpportunity()[0];
            ...
            else
            {
                ...
                {
                    opportunityInDynamics2["parentaccountid"] = new EntityReference("account", (Guid)accountEntity[0].Id);
                    service.Update(opportunityInDynamics2);
                }                                  
            }
            ...
            else
            {
                ...
                { 
                    opportunityInDynamics2["parentcontactid"] = new EntityReference("contact", (Guid)contactEntity[0].Id);
                    service.Update(opportunityInDynamics2);
                }
            }                
        }
